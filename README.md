# Freedom of Expression vs. COVID Response

## Introduction

This project focuses on how freedom of expression in a particular country compares to the *strictness* of the country's COVID response.
...
- `data/human-freedom-index-2019.csv`
    - This project measures freedom of expression using data from the Human Freedom Index 2019 (https://www.cato.org/human-freedom-index/2019).
